...
import ChooseSide from "../../assets/ChooseSide.png";
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ width: "100%", flex: 1 }}>
        <View style={styles.header}>
          <Image source={sideDish} style={styles.image} />
          <Image source={ChooseSide} style={styles.imageText} />
        </View>
        <Text style={styles.resultText}>
          Choose between dry veg and curry options
        </Text>
        <View
          style={{
          ...
          <View style={styles.subSection}>
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    selectedItems.side === "Channa Masala"
                      ? "#7ed957"
                      : undefined,
                },
              ]}
              onPress={() => handleSelectItem("side", "Channa Masala")}
            >
          ...
          <View style={styles.subSection}>
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    selectedItems.side2 === "Mixed Veg" ? "#7ed957" : undefined,
                },
              ]}
              onPress={() => handleSelectItem("side2", "Mixed Veg")}
            >
              <Ionicons name="checkmark" size={20} color="#fff" />
            </TouchableOpacity>
          </View>
        </View>
        {selectedItems.side2 === "Mixed Veg" && (
          <View style={styles.pickerContainer}>
            <RNPickerSelect
